...
$lang = array_merge($lang, array(
	...
	'CT_SHOW_LINK' 						=> 'Рассказать другим о CleanTalk',
	'CT_SHOW_LINK_EXPLAIN' 				=> 'Включение этой опции разместит небольшую сслку на нас на страницах форума',
	'CT_DEBUG' 							=> 'Включить отладку',
	'CT_DEBUG_EXPLAIN'					=> 'Хранить статистику подключения в лог файле',	
));
